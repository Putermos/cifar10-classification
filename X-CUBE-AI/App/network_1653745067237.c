...
#include "network_1653745067237.h"
#include "network_1653745067237_data.h"
...
#define AI_NET_OBJ_INSTANCE g_network_1653745067237
 
#undef AI_NETWORK_1653745067237_MODEL_SIGNATURE
#define AI_NETWORK_1653745067237_MODEL_SIGNATURE     "e2308ee168a52eb19cfed701bdfcaee6"
...
#define AI_TOOLS_DATE_TIME   "Sun May 29 15:30:39 2022"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_NETWORK_1653745067237_N_BATCHES
#define AI_NETWORK_1653745067237_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    140800, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1653745067237_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1653745067237_OUT_NUM, &activation_6_output),
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool network_1653745067237_configure_activations(
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool network_1653745067237_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_network_1653745067237_get_info(
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_NETWORK_1653745067237_MODEL_NAME,
      .model_signature   = AI_NETWORK_1653745067237_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_bool ai_network_1653745067237_get_report(
  ai_handle network, ai_network_report* report)
{
  ai_network* net_ctx = AI_NETWORK_ACQUIRE_CTX(network);
...
AI_API_ENTRY
ai_error ai_network_1653745067237_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_network_1653745067237_create(
...
AI_API_ENTRY
ai_error ai_network_1653745067237_create_and_init(
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
    ai_error err;
    ai_network_params params;

    err = ai_network_1653745067237_create(network, AI_NETWORK_1653745067237_DATA_CONFIG);
    if (err.type != AI_ERROR_NONE)
        return err;
    if (ai_network_1653745067237_data_params_get(&params) != true) {
        err = ai_network_1653745067237_get_error(*network);
        return err;
    }
#if defined(AI_NETWORK_1653745067237_DATA_ACTIVATIONS_COUNT)
    if (activations) {
...
#endif
#if defined(AI_NETWORK_1653745067237_DATA_WEIGHTS_COUNT)
    if (weights) {
...
#endif
    if (ai_network_1653745067237_init(*network, &params) != true) {
        err = ai_network_1653745067237_get_error(*network);
    }
    return err;
}
...
AI_API_ENTRY
ai_buffer* ai_network_1653745067237_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_network_1653745067237_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    ((ai_network *)network)->magic = AI_MAGIC_CONTEXT_TOKEN;
...
AI_API_ENTRY
ai_handle ai_network_1653745067237_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_network_1653745067237_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= network_1653745067237_configure_weights(net_ctx, params);
  ok &= network_1653745067237_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_network_1653745067237_run(
...
AI_API_ENTRY
ai_i32 ai_network_1653745067237_forward(ai_handle network, const ai_buffer* input)
{
