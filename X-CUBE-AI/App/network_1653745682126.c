/**
  ******************************************************************************
  * @file    network_1653745682126.c
  * @author  AST Embedded Analytics Research Platform
  * @date    Sun May 29 15:30:47 2022
...
#include "network_1653745682126.h"
#include "network_1653745682126_data.h"
...
#define AI_NET_OBJ_INSTANCE g_network_1653745682126
 
#undef AI_NETWORK_1653745682126_MODEL_SIGNATURE
#define AI_NETWORK_1653745682126_MODEL_SIGNATURE     "e2308ee168a52eb19cfed701bdfcaee6"
...
#define AI_TOOLS_DATE_TIME   "Sun May 29 15:30:47 2022"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_NETWORK_1653745682126_N_BATCHES
#define AI_NETWORK_1653745682126_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 874728, 1, 1),
    874728, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 140800, 1, 1),
    140800, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1653745682126_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1653745682126_OUT_NUM, &activation_6_output),
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool network_1653745682126_configure_activations(
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    conv2d_1_conv2d_output_array.data = AI_PTR(activations_map[0] + 2048);
    conv2d_1_conv2d_output_array.data_start = AI_PTR(activations_map[0] + 2048);
    conv2d_2_conv2d_scratch0_array.data = AI_PTR(activations_map[0] + 133120);
    conv2d_2_conv2d_scratch0_array.data_start = AI_PTR(activations_map[0] + 133120);
    ...
    conv2d_3_conv2d_output_array.data = AI_PTR(activations_map[0] + 28800);
    conv2d_3_conv2d_output_array.data_start = AI_PTR(activations_map[0] + 28800);
    conv2d_4_conv2d_scratch0_array.data = AI_PTR(activations_map[0] + 0);
    conv2d_4_conv2d_scratch0_array.data_start = AI_PTR(activations_map[0] + 0);
    conv2d_4_conv2d_output_array.data = AI_PTR(activations_map[0] + 6656);
    conv2d_4_conv2d_output_array.data_start = AI_PTR(activations_map[0] + 6656);
    ...
    activation_5_output_array.data = AI_PTR(activations_map[0] + 2048);
    activation_5_output_array.data_start = AI_PTR(activations_map[0] + 2048);
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool network_1653745682126_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)
  ...
  if (ai_platform_get_weights_map(weights_map, 1, params)) {
    ...
    conv2d_1_conv2d_bias_array.data = AI_PTR(weights_map[0] + 3456);
    conv2d_1_conv2d_bias_array.data_start = AI_PTR(weights_map[0] + 3456);
    conv2d_2_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_conv2d_weights_array.data = AI_PTR(weights_map[0] + 3584);
    conv2d_2_conv2d_weights_array.data_start = AI_PTR(weights_map[0] + 3584);
    conv2d_2_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_conv2d_bias_array.data = AI_PTR(weights_map[0] + 40448);
    conv2d_2_conv2d_bias_array.data_start = AI_PTR(weights_map[0] + 40448);
    conv2d_3_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_conv2d_weights_array.data = AI_PTR(weights_map[0] + 40576);
    conv2d_3_conv2d_weights_array.data_start = AI_PTR(weights_map[0] + 40576);
    conv2d_3_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_conv2d_bias_array.data = AI_PTR(weights_map[0] + 114304);
    conv2d_3_conv2d_bias_array.data_start = AI_PTR(weights_map[0] + 114304);
    conv2d_4_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_conv2d_weights_array.data = AI_PTR(weights_map[0] + 114560);
    conv2d_4_conv2d_weights_array.data_start = AI_PTR(weights_map[0] + 114560);
    conv2d_4_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_conv2d_bias_array.data = AI_PTR(weights_map[0] + 262016);
    conv2d_4_conv2d_bias_array.data_start = AI_PTR(weights_map[0] + 262016);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(weights_map[0] + 262336);
    dense_1_dense_weights_array.data_start = AI_PTR(weights_map[0] + 262272);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(weights_map[0] + 852160);
    dense_1_dense_bias_array.data_start = AI_PTR(weights_map[0] + 852160);
    dense_2_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_weights_array.data = AI_PTR(weights_map[0] + 854208);
    dense_2_dense_weights_array.data_start = AI_PTR(weights_map[0] + 854208);
    dense_2_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_bias_array.data = AI_PTR(weights_map[0] + 874688);
    dense_2_dense_bias_array.data_start = AI_PTR(weights_map[0] + 874688);
    return true;
  }
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_network_1653745682126_get_info(
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_NETWORK_1653745682126_MODEL_NAME,
      .model_signature   = AI_NETWORK_1653745682126_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_bool ai_network_1653745682126_get_report(
  ai_handle network, ai_network_report* report)
{
  ai_network* net_ctx = AI_NETWORK_ACQUIRE_CTX(network);
...
AI_API_ENTRY
ai_error ai_network_1653745682126_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_network_1653745682126_create(
...
AI_API_ENTRY
ai_error ai_network_1653745682126_create_and_init(
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
    ai_error err;
    ai_network_params params;

    err = ai_network_1653745682126_create(network, AI_NETWORK_1653745682126_DATA_CONFIG);
    if (err.type != AI_ERROR_NONE)
        return err;
    if (ai_network_1653745682126_data_params_get(&params) != true) {
        err = ai_network_1653745682126_get_error(*network);
        return err;
    }
#if defined(AI_NETWORK_1653745682126_DATA_ACTIVATIONS_COUNT)
    if (activations) {
...
#endif
#if defined(AI_NETWORK_1653745682126_DATA_WEIGHTS_COUNT)
    if (weights) {
...
#endif
    if (ai_network_1653745682126_init(*network, &params) != true) {
        err = ai_network_1653745682126_get_error(*network);
    }
    return err;
}
...
AI_API_ENTRY
ai_buffer* ai_network_1653745682126_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_network_1653745682126_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    ((ai_network *)network)->magic = AI_MAGIC_CONTEXT_TOKEN;
...
AI_API_ENTRY
ai_handle ai_network_1653745682126_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_network_1653745682126_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= network_1653745682126_configure_weights(net_ctx, params);
  ok &= network_1653745682126_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_network_1653745682126_run(
...
AI_API_ENTRY
ai_i32 ai_network_1653745682126_forward(ai_handle network, const ai_buffer* input)
{
