...
#ifndef AI_NETWORK_1653745682126_H
#define AI_NETWORK_1653745682126_H
#pragma once

#include "network_1653745682126_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_1653745682126_MODEL_NAME          "network_1653745682126"
#define AI_NETWORK_1653745682126_ORIGIN_MODEL_NAME   "hanicifar10"

/******************************************************************************/
#define AI_NETWORK_1653745682126_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_NETWORK_1653745682126_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_1653745682126_IN \
  ai_network_1653745682126_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1653745682126_IN_SIZE { \
  AI_NETWORK_1653745682126_IN_1_SIZE, \
}
#define AI_NETWORK_1653745682126_IN_SIZE_BYTES { \
  AI_NETWORK_1653745682126_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_1653745682126_IN_1_HEIGHT      (32)
#define AI_NETWORK_1653745682126_IN_1_WIDTH       (32)
#define AI_NETWORK_1653745682126_IN_1_CHANNEL     (3)
#define AI_NETWORK_1653745682126_IN_1_SIZE        (32 * 32 * 3)
#define AI_NETWORK_1653745682126_IN_1_SIZE_BYTES  (12288)

/******************************************************************************/
#define AI_NETWORK_1653745682126_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_1653745682126_OUT \
  ai_network_1653745682126_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1653745682126_OUT_SIZE { \
  AI_NETWORK_1653745682126_OUT_1_SIZE, \
}
#define AI_NETWORK_1653745682126_OUT_SIZE_BYTES { \
  AI_NETWORK_1653745682126_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_1653745682126_OUT_1_CHANNEL     (10)
#define AI_NETWORK_1653745682126_OUT_1_SIZE        (10)
#define AI_NETWORK_1653745682126_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_NETWORK_1653745682126_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_1653745682126
 ...
 * @ref ai_network_1653745682126_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_1653745682126_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1653745682126_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1653745682126_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_1653745682126_*
 * defines into file @ref network_1653745682126.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_1653745682126_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_1653745682126_H */
